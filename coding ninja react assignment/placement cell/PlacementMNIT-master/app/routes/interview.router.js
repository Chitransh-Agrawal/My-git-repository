...
router.get('/getAll', jwtMiddleware.verify,   interviewController.getAll);
router.get('/getAll_admin', jwtMiddleware.verify, authMiddleware.ensureOfficialPlacementTeam, interviewController.getAll_admin);
router.get('/getOne/:experience_id', jwtMiddleware.verify,   interviewController.getOne);
router.post('/add', jwtMiddleware.verify,   interviewController.add);
